...
python main.py --dataset_name pascal --dataset_dir ~/research/datasets/Pascal3D \
       ...
       --checkpoint_dir checkpoint/car_plane_1_small_symmetric --log_dir log/car_plane_1_small_symmetric \
...
python main.py --dataset_name pascal --dataset_dir ~/research/datasets/Pascal3D \
       ...
       --checkpoint_dir checkpoint/car_plane_2_small_symmetric --log_dir log/car_plane_2_small_symmetric \
