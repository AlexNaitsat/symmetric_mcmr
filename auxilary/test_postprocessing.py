...
def test_symmetrization_3d_results():
    ...
    # result_path_list = ['save/not_symmetric/car_10_MRCNN_small/car_small-qualitative', \
    #                     'save/symmetric/car_10_MRCNN_small/car_small-qualitative', \
    ...
    # experiment_name = 'small_draft_resumed'
    # result_path_list = [\
    #                      'save/not_symmetric/car_10_MRCNN_small/car_small-qualitative', \
    #                      'save/plane_car_1_PointRend_small/aeroplane_small-car_small-qualitative',\
    #                      ]    
    # resume_pkl = "draft/intermediate_3D_metrics-small_draft-100_voxel_without_rescaling.pkl"
    ...
    # result_path_list = [ \
    #                     # 'save/Pascal3D_12_classes_12_PointRend_small/aeroplane_small-bicycle_small-boat_small-bottle_small-bus_small-car_small-chair_small-diningtable_small-motorbike_small-sofa_small-train_small-tvmonitor_small-qualitative', \
    #                     # 'save/Pascal3D_12_classes_1_PointRend_small/aeroplane_small-bicycle_small-boat_small-bottle_small-bus_small-car_small-chair_small-diningtable_small-motorbike_small-sofa_small-train_small-tvmonitor_small-qualitative', \
    #                     'save/plane_8_MRCNN_small/aeroplane_small-qualitative/', \
    #                     # 'save/not_symmetric/car_10_MRCNN_small/car_small-qualitative', \
    #                     # 'save/plane_car_1_PointRend_small/aeroplane_small-car_small-qualitative',\
...
#returns dictionaries of symmetrization indices to symmetrization names for meshes with a given number of horizontal slices
...
if __name__ == "__main__":
    ...
    slice_number = 3 # (last  test with slice_number=2) <- if = 1, then check contant symmetrization per mesh (like in previous script versions)
    ...
    print('\n-W- This script is depricated !\nRun instead auxilary/test_postprocessing_par.py with  enable_parallel_run = False ')
